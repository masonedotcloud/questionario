...
/**
 * Visualizzazione pagina di registratore
 */
@WebServlet("/form/register/view")
public class View extends HttpServlet {
    ...
    /**
     * Gestisce le richieste GET per la visualizzazione della pagina di visualizzazione form.
     *
